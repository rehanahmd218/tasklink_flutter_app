    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Text('Withdrawal Amount', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.bold, color: isDark ? Colors.grey[200] : const Color(0xFF1c1c0d))),
            TextButton(
              onPressed: () => controller.text = maxAmount,
              child: Text('Max: \$$maxAmount', style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: TColors.primary)),
            ),
          ],
        ),
