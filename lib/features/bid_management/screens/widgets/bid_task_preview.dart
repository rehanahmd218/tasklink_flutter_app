          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(title, style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black), maxLines: 1, overflow: TextOverflow.ellipsis),
                  Text('View task details', style: GoogleFonts.inter(fontSize: 12, color: TColors.primary.withValues(alpha: 0.8), fontWeight: FontWeight.w500)),
                ],
              ),
            ),
