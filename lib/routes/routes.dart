class Routes {
  ...
  static const HOME_TAB = '/home-tab'; // Individual Home Tab if needed, but usually handled by NavMenu
  ...
  static List<String> all = [
     LOGIN, REGISTER, FORGOT_PASSWORD, RESET_PASSWORD, VERIFICATION,
    HOME, HOME_TAB,
    TASK_DETAILS, TASK_DETAILS_TASKER,
    POST_TASK, PLACE_BID, MY_POSTED_TASKS, MY_TASKS, BID_MANAGEMENT,
    CHAT_LIST, CHAT_ROOM,
    DISPUTE, NOTIFICATIONS, PAYMENT,
    PROFILE, EDIT_PROFILE, PORTFOLIO,
    WRITE_REVIEW, COMPLETE_RATINGS,
    SETTINGS,
    WALLET, TOP_UP, WITHDRAW,
    DASHBOARD,
  ];
}
