...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.RESET_PASSWORD, page: () => const ResetPasswordScreen()),
    GetPage(name: Routes.VERIFICATION, page: () => const VerificationScreen()),

    GetPage(name: Routes.HOME, page: () => const NavigationMenu()),
    GetPage(name: Routes.HOME_TAB, page: () => const HomeScreen()), // Usually embedded, but route accessible

    GetPage(name: Routes.TASK_DETAILS, page: () => const TaskDetailsScreen()),
    ...
    GetPage(name: Routes.BID_MANAGEMENT, page: () => const BidManagementScreen()),
    ...
    GetPage(name: Routes.COMPLETE_RATINGS, page: () => const CompleteRatingsScreen()),
    ...
    GetPage(name: Routes.DASHBOARD, page: () => const InProgressDashboardScreen()),
  ];
}
